package com.cricket.CricketInformer.entity;
...
public class Match {
    ...
    public void setMatchStatus() {
        if(textComplete.isBlank()) this.status = MatchStatus.LIVE;
        else this.status = MatchStatus.COMPLETED;
    }


    public Match(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String bowlTeam, String battingTeamScore, String bowlTeamScore, String liveText, String matchLink, String textComplete, Date date, MatchStatus status) {
